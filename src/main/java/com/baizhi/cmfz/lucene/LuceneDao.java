...
public interface LuceneDao {
     ...
     */
    boolean createIndex(List<Article> cmfzArticleList);
     ...
     * @return 成功返回true  失败返回false
     */
    boolean addIndex(Article article);
     ...
     * @return
     */
    boolean resettingIndex(List<Article> cmfzArticleList);
     ...
     * @return 成功返回true  失败返回false
     */
    boolean updateIndexById(Article cmfzArticle);
    /**
